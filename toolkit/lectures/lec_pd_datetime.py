...
CSVLOC = os.path.join(cfg.DATADIR, 'qan_stk_prc.csv')
...
# | %U        | Week number of the year (Sunday as the first day of the week) | 00, 01, â€¦, 53            |
# | %W        | Week number of the year (Monday as the first day of the week) | 00, 01, â€¦, 53            |
